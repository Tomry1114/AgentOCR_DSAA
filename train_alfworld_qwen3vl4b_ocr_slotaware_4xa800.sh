...
experiment_name="${TRAINER_EXPERIMENT_NAME:-agentocr_qwen3vl4b_ocr_slotaware_4xa800_s${seed}}"
...
echo "Launching 4xA800 Qwen3-VL-4B OCR+slotaware run: seed=${seed} experiment=${experiment_name}"
