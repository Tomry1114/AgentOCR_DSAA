...
config_file="${QWEN3VL4B_4XA800_CONFIG:-$(pwd)/configs/qwen3vl4b_ocr_4xa800.env}"
...
seed="${SEED}"
experiment_name="${TRAINER_EXPERIMENT_NAME:-agentocr_qwen3vl4b_ocr_4xa800_s${seed}}"
prepare_local_dir="${PREPARE_LOCAL_DIR:-$HOME/data/verl-agent-q3vl4b-ocr/}"
...
echo "Launching 4xA800 Qwen3-VL-4B OCR run: seed=${seed} experiment=${experiment_name}"
