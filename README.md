...
This repository is our `DSAA5013` course project based on `AgentOCR`, a framework for long-horizon LLM/VLM agents.
...
## Why We Chose It for DSAA5013

We chose AgentOCR as our `DSAA5013` course project for three main reasons.
