...
config_file="${QWEN3VL2B_8XA800_CONFIG:-$(pwd)/configs/qwen3vl2b_slotaware_8xa800.env}"
...
echo "Launching 8xA800 Qwen3-VL-2B run: variant=${variant} seed=${seed} experiment=${TRAINER_EXPERIMENT_NAME}"
