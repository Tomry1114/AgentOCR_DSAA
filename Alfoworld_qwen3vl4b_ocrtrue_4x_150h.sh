...
#SBATCH --job-name=q3vl4b_ocrtrue4x
...
export TRAINER_EXPERIMENT_NAME="${TRAINER_EXPERIMENT_NAME:-agentocr_q3vl4b_ocrtrue4x_150h_eager_s0}"
export TRAINER_N_GPUS_PER_NODE=4
export TRAINER_TOTAL_EPOCHS=150

export TRAIN_FILE=/hpc2hdd/home/rtang906/data/verl-agent/visual/train.parquet
export VAL_FILE=/hpc2hdd/home/rtang906/data/verl-agent/visual/test.parquet
...
export VLLM_SKIP_MM_PROFILING=True
